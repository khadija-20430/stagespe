...
async function main() {
    ...
    if (!fullName || !email || !password) {
        console.log('Usage : node scripts/createAdmin.js "Amelia" na_tararbit@esi.dz TonMotDePasse1 [role]');
    ...
    try {
       ...
       RETURNING id, full_name, email, role`, [fullName, email, password_hash, finalRole]
        );
