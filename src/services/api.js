...
export const getProjetTranslations = async (id) => authRequest(`/projects/${id}/translations`);

export const updateProjetTranslations = async (id, payload) =>
    authRequest(`/projects/${id}/translations`, { method: 'PUT', body: payload });

export const createProjet = (payload) =>
    authRequest('/projects', { method: 'POST', body: payload });

export const updateProjet = (id, payload) =>
    authRequest(`/projects/${id}`, { method: 'PUT', body: payload });

export const deleteProjet = (id) =>
    authRequest(`/projects/${id}`, { method: 'DELETE' });

export const publishProjet = (id) =>
    authRequest(`/projects/${id}/publish`, { method: 'PATCH' });
...
export const getCallTranslations = async (id) => authRequest(`/calls/${id}/translations`);

export const updateCallTranslations = async (id, payload) =>
    authRequest(`/calls/${id}/translations`, { method: 'PUT', body: payload });

export const createAppel = (payload) =>
    authRequest('/calls', { method: 'POST', body: payload });

export const updateAppel = (id, payload) =>
    authRequest(`/calls/${id}`, { method: 'PUT', body: payload });

export const deleteAppel = (id) =>
    authRequest(`/calls/${id}`, { method: 'DELETE' });

export const publishAppel = (id) =>
    authRequest(`/calls/${id}/publish`, { method: 'PATCH' });

export const archiveAppel = (id) =>
    authRequest(`/calls/${id}/archive`, { method: 'PATCH' });
...
export const getMobilitiesTranslations = async (id) => authRequest(`/mobility/${id}/translations`);

export const updateMobilitiesTranslations = async (id, payload) =>
    authRequest(`/mobility/${id}/translations`, { method: 'PUT', body: payload });

export const createMobilite = (payload) =>
    authRequest('/mobility', { method: 'POST', body: payload });

export const updateMobilite = (id, payload) =>
    authRequest(`/mobility/${id}`, { method: 'PUT', body: payload });

export const deleteMobilite = (id) =>
    authRequest(`/mobility/${id}`, { method: 'DELETE' });

export const publishMobilite = (id) =>
    authRequest(`/mobility/${id}/publish`, { method: 'PATCH' });

export const archiveMobilite = (id) =>
    authRequest(`/mobility/${id}/archive`, { method: 'PATCH' });
...
export const getPartenaireTranslations = async (id) => authRequest(`/partners/${id}/translations`);

export const updatePartenaireTranslations = async (id, payload) =>
    authRequest(`/partners/${id}/translations`, { method: 'PUT', body: payload });

export const getPartenairesMap = async () => request('/partners/map');

export const createPartenaire = (payload) =>
    authRequest('/partners', { method: 'POST', body: payload });

export const updatePartenaire = (id, payload) =>
    authRequest(`/partners/${id}`, { method: 'PUT', body: payload });

export const deletePartenaire = (id) =>
    authRequest(`/partners/${id}`, { method: 'DELETE' });

export const publishPartner = (id) =>
    authRequest(`/partners/${id}/publish`, { method: 'PATCH' });
...
export const getActualites = async (lang = 'fr') => {
    const data = await request(`/news-events?lang=${lang}`);
    return data.map(mapActualite);
};

export const getActualiteById = async (id, lang = 'fr') => {
    const data = await request(`/news-events/${id}?lang=${lang}`);
...
export const getActualiteTranslations = async (id) => authRequest(`/news-events/${id}/translations`);

export const updateActualiteTranslations = async (id, payload) =>
    authRequest(`/news-events/${id}/translations`, { method: 'PUT', body: payload });

export const createActualite = (payload) =>
    authRequest('/news-events', { method: 'POST', body: payload });

export const updateActualite = (id, payload) =>
    authRequest(`/news-events/${id}`, { method: 'PUT', body: payload });

export const deleteActualite = (id) =>
    authRequest(`/news-events/${id}`, { method: 'DELETE' });

export const publishActualite = (id) =>
    authRequest(`/news-events/${id}/publish`, { method: 'PATCH' });

export const archiveActualite = (id) =>
    authRequest(`/news-events/${id}/archive`, { method: 'PATCH' });
...
export const getDocumentsAdmin = async () => {
    const data = await authRequest('/documents/admin/all');
    return data.map(mapDocument);
};
...
export const getDocumentTranslations = async (id) => authRequest(`/documents/${id}/translations`);

export const updateDocumentTranslations = async (id, payload) =>
    authRequest(`/documents/${id}/translations`, { method: 'PUT', body: payload });
...
export const createDocument = (payload) =>
    authRequest('/documents', { method: 'POST', body: payload });

export const updateDocument = (id, payload) =>
    authRequest(`/documents/${id}`, { method: 'PUT', body: payload });

export const deleteDocument = (id) =>
    authRequest(`/documents/${id}`, { method: 'DELETE' });

// Publication / archivage — routes dédiées côté backend

export const publishDocument = (id) =>
    authRequest(`/documents/${id}/publish`, { method: 'PUT' });

export const archiveDocument = (id) =>
    authRequest(`/documents/${id}/archive`, { method: 'PUT' });

// Liaisons avec entités (projets, appels, conventions, mobilités, programmes)

export const linkDocument = (documentId, entityType, entityId) =>
    authRequest(`/documents/${documentId}/link`, {
        method: 'POST',
        body: { entity_type: entityType, entity_id: entityId },
    });

export const unlinkDocument = (documentId, entityType, entityId) =>
    authRequest(`/documents/${documentId}/link`, {
        method: 'DELETE',
        body: { entity_type: entityType, entity_id: entityId },
    });
...
export const syncDocumentLinks = async (documentId, previousLinks = {}, newLinksBySelection = {}) => {
    ...
    for (const type of entityTypes) {
        const before = new Set((previousLinks[type] || []).map(String));
        const after = new Set((newLinksBySelection[type] || []).map(String));

        for (const id of after) {
            if (!before.has(id)) await linkDocument(documentId, type, id);
        }
        for (const id of before) {
            if (!after.has(id)) await unlinkDocument(documentId, type, id);
        }
    }
};
...
export const getCountries = (lang = 'fr') => request(`/countries?lang=${lang}`);
...
export const getThemes = (lang = 'fr') => request(`/themes?lang=${lang}`);
...
export const createRole = (payload) =>
    authRequest('/roles', { method: 'POST', body: payload });

export const updateRole = (id, payload) =>
    authRequest(`/roles/${id}`, { method: 'PUT', body: payload });

export const deleteRole = (id) =>
    authRequest(`/roles/${id}`, { method: 'DELETE' });

export const setRolePermissions = (id, permissionIds) =>
    authRequest(`/roles/${id}/permissions`, {
        method: 'PUT',
        body: { permission_ids: permissionIds },
    });

export const toggleRolePermission = (id, permissionId, enabled) =>
    authRequest(`/roles/${id}/permissions/toggle`, {
        method: 'PUT',
        body: { permission_id: permissionId, enabled },
    });
...
export const registerUser = (payload) =>
    authRequest('/auth/register', { method: 'POST', body: payload });

export const activateUser = (id) =>
    authRequest(`/auth/users/${id}/activate`, { method: 'PUT' });

export const deactivateUser = (id) =>
    authRequest(`/auth/users/${id}/deactivate`, { method: 'PUT' });

export const updateUserRole = (id, role) =>
    authRequest(`/auth/users/${id}/role`, { method: 'PUT', body: { role } });

export const assignRoleToUser = (id, roleId) =>
    authRequest(`/auth/users/${id}/assign-role`, {
        method: 'PUT',
        body: { role_id: roleId },
    });
...
export const updateUserProfile = (id, payload) =>
    authRequest(`/auth/users/${id}/profile`, { method: 'PUT', body: payload });
...
export const getResetSettings = () => authRequest('/settings');

export const updateResetSettings = (payload) =>
    authRequest('/settings', { method: 'PUT', body: payload });
...
export const getAgreementsAdmin = async () => {
    const data = await authRequest('/agreements/admin/all');
    return data.map(mapAgreement);
};
...
export const getAgreementTranslations = async (id) => authRequest(`/agreements/${id}/translations`);

export const updateAgreementTranslations = async (id, payload) =>
    authRequest(`/agreements/${id}/translations`, { method: 'PUT', body: payload });

export const createAgreement = (payload) =>
    authRequest('/agreements', { method: 'POST', body: payload });

export const updateAgreement = (id, payload) =>
    authRequest(`/agreements/${id}`, { method: 'PUT', body: payload });

export const deleteAgreement = (id) =>
    authRequest(`/agreements/${id}`, { method: 'DELETE' });
...
export const getSchoolPresentations = async () => request('/school-presentation');

export const getSchoolPresentationById = async (id) => request(`/school-presentation/${id}`);
...
export const getSchoolPresentationsAdmin = async () => authRequest('/school-presentation/admin/all');
...
export const updateSchoolTranslation = async (translationId, payload) =>
    authRequest(`/school-presentation/translations/${translationId}`, {
        method: 'PUT',
        body: payload,
    });
...
export const getSchoolRevisions = async (translationId) =>
    authRequest(`/school-presentation/translations/${translationId}/revisions`);

export const updateSchoolVisibilite = async (id, visibilite) =>
    authRequest(`/school-presentation/${id}/visibilite`, {
        method: 'PATCH',
        body: { visibilite },
    });

export const publishSchoolPresentation = async (id) =>
    authRequest(`/school-presentation/${id}/publish`, { method: 'PUT' });

export const archiveSchoolPresentation = async (id) =>
    authRequest(`/school-presentation/${id}/archive`, { method: 'PUT' });

export const deleteSchoolPresentation = async (id) =>
    authRequest(`/school-presentation/${id}`, { method: 'DELETE' });

export const deleteSchoolTranslation = async (translationId) =>
    authRequest(`/school-presentation/translations/${translationId}`, { method: 'DELETE' });
...
export const getNotifications = async (limit = 50, offset = 0) =>
    authRequest(`/notifications/me?limit=${limit}&offset=${offset}`);

export const getUnreadNotifications = async () => authRequest('/notifications/me/unread');

export const getUnreadCount = async () => authRequest('/notifications/me/unread-count');

export const markAsRead = async (id) =>
    authRequest(`/notifications/${id}/read`, { method: 'PUT' });

export const markAllAsRead = async () =>
    authRequest('/notifications/me/read-all', { method: 'PUT' });

export const deleteNotification = async (id) =>
    authRequest(`/notifications/${id}`, { method: 'DELETE' });

export const deleteAllNotifications = async () =>
    authRequest('/notifications/me/all', { method: 'DELETE' });

// Routes admin (super_admin uniquement)

export const getAllNotificationsAdmin = async (limit = 100, offset = 0) =>
    authRequest(`/notifications/admin/all?limit=${limit}&offset=${offset}`);

export const createNotification = async (data) =>
    authRequest('/notifications/admin', { method: 'POST', body: data });

export const createNotificationsForUsers = async (data) =>
    authRequest('/notifications/admin/bulk', { method: 'POST', body: data });

export const createNotificationsByRole = async (data) =>
    authRequest('/notifications/admin/by-role', { method: 'POST', body: data });

export const deleteAllNotificationsByUser = async (userId) =>
    authRequest(`/notifications/admin/user/${userId}/all`, { method: 'DELETE' });
...
export const publishProgramme = (id) =>
    authRequest(`/programmes/${id}/publish`, { method: 'PATCH' });

export const archiveProgramme = (id) =>
    authRequest(`/programmes/${id}/archive`, { method: 'PATCH' });

// ============================================================
// HOME SLIDES
// ============================================================

export const getHomeSlidesAdmin = (lang = 1) => authRequest(`/home-slides/admin/all?lang=${lang}`);
export const getHomeSlides = (lang = 1) => request(`/home-slides?lang=${lang}`);

export const createHomeSlide = (payload) =>
    authRequest('/home-slides', { method: 'POST', body: payload });

export const updateHomeSlide = (id, payload) =>
    authRequest(`/home-slides/${id}`, { method: 'PUT', body: payload });

export const deleteHomeSlide = (id) =>
    authRequest(`/home-slides/${id}`, { method: 'DELETE' });

export const updateHomeSlideStatus = (id, status) =>
    authRequest(`/home-slides/${id}/status`, { method: 'PUT', body: { status } });

export const reorderHomeSlides = (slides) =>
    authRequest('/home-slides/reorder', { method: 'PUT', body: { slides } });

// ============================================================
// TRADUCTIONS THÈMES / PAYS
// ============================================================

export const getThemeTranslations = (id) => authRequest(`/themes/${id}/translations`);

export const updateThemeTranslations = (id, payload) =>
    authRequest(`/themes/${id}/translations`, { method: 'PUT', body: payload });

export const getCountryTranslations = (id) => authRequest(`/countries/${id}/translations`);

export const updateCountryTranslations = (id, payload) =>
    authRequest(`/countries/${id}/translations`, { method: 'PUT', body: payload });
...
export const createPartnerContact = (payload) =>
    authRequest('/partner-contacts', { method: 'POST', body: payload });

export const updatePartnerContact = (id, payload) =>
    authRequest(`/partner-contacts/${id}`, { method: 'PUT', body: payload });

export const deletePartnerContact = (id) =>
    authRequest(`/partner-contacts/${id}`, { method: 'DELETE' });
export const getDocumentRevisions = (id) => authRequest(`/documents/${id}/revisions`);
